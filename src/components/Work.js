        ...
        <div className="sec6-parent-row">
          ...
          <div className="sec6-row top">
            ...
            <div className="sec6-col sec6-col2">
              ...
              <h5 className="para2 sec6-para2">Developers Platform</h5>
              <p className="para2 sec6-para">
                Create beautiful & aesthetic projects from beginners to guru
                level.. A lot of frontend concepts & logics used here i.e desgin
                conversion, APIs integration & development etc
              </p>
            </div>
            <div className="sec6-col sec6-col3">
              <a
          ...
          <div className="sec6-row top">
            ...
            <div className="sec6-col sec6-col2">
              ...
              <p className="para2 sec6-para">
                Upwork is the world's work marketplace. It connects businesses
